...
void qeiInit(void) {
	...
	QEIConfigure(QEI0_BASE,QEI_CONFIG_CAPTURE_A_B | QEI_CONFIG_QUADRATURE | QEI_CONFIG_NO_RESET | ENCODER_A_SWAP,(PPR*4)-1);
	...
	QEIConfigure(QEI1_BASE,QEI_CONFIG_CAPTURE_A_B | QEI_CONFIG_QUADRATURE | QEI_CONFIG_NO_RESET | ENCODER_B_SWAP,(PPR*4)-1);
